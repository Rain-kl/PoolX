  ...
  ({ className, viewportRows, rowHeight, ...props }, ref) => (
    <div
      ...
      className={cn(
        ...
        viewportRows &&
          '[&_thead]:sticky [&_thead]:top-0 [&_thead]:z-30 [&_thead]:bg-background',
      )}
      style={
        viewportRows && rowHeight
          ? { maxHeight: 36 + viewportRows * rowHeight }
          : undefined
      }
    >
      <table
...
>(({ className, ...props }, ref) => (
  <TableHead
    ref={ref}
    className={cn(
      'sticky right-0 z-20 w-12 min-w-12 bg-background px-2',
      className,
    )}
    {...props}
  />
