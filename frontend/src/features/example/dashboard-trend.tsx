...
import type {
  DashboardDTO,
  DashboardPeriod,
} from '@/features/example/dashboard-types';
import {
  formatCompactNumber,
  formatCompactUSD,
  formatUSDValue,
          ...
          >
            ...
            >
              ...
              <YAxis
                ...
                allowDecimals
                tickFormatter={(value) =>
                  formatCompactUSD(Number(value), locale)
                }
              />
              <YAxis
                yAxisId='requests'
                      ...
                      <div className='flex w-full items-center justify-between gap-4'>
                        <span className='flex min-w-0 items-center gap-2 text-xs font-normal text-muted-foreground'>
                          <span
                            ...
                            style={{
                              backgroundColor:
                                item.color || `var(--color-${String(name)})`,
                            }}
                          />
...
function SeriesLegendMark({ series }: { series: TrendSeries }) {
  ...
  return (
    <span
      className={cn(
        'w-3 shrink-0 border-t',
        series === 'requests' && 'border-dashed',
      )}
